...
export default function HeroArchitecture({ activeTab, onTabChange }: {
  ...
  return (
    <div ref={ref} className="hero-architecture" data-running={active || replay > 0} data-stage={activeTab}>
      ...
      <svg key={`${activeTab}-${replay}`} className="architecture-art" viewBox="0 0 440 146" fill="none" aria-hidden="true" focusable="false">
        ...
        <g className="architecture-foundation" stroke="currentColor" strokeLinejoin="round">
          <path d="m76 106 127-55 161 48-129 44z" fill="#d4b27c" fillOpacity="0.035" strokeOpacity="0.5" />
          <path d="m76 106 159 37 129-44M235 143v-9M76 106v-9M364 99v-9" strokeOpacity="0.3" />
          <path d="m92 107 111-46 143 39-111 36z" strokeOpacity="0.28" strokeDasharray="3 4" />
        </g>
        {/* Two interlocking architectural volumes, drawn entirely with SVG paths. */}
        <g className="architecture-building architecture-building-back" stroke="currentColor" strokeLinejoin="round" strokeWidth="1.15">
          ...
          <path d="m161 57 56 17v12l-56-17zm0 22 56 17v12l-56-17z" strokeOpacity="0.5" />
          <path d="M179 63v12m19-7v13m-19 4v12m19-6v12" strokeOpacity="0.4" />
          <path d="m237 73 28-14v13l-28 14zm0 23 28-14v9l-28 16z" strokeOpacity="0.45" />
        </g>
        <g className="architecture-building architecture-building-front" stroke="currentColor" strokeLinejoin="round" strokeWidth="1.15">
          ...
          <path d="M245 106v14m14-10v14M303 108v13" strokeOpacity="0.5" />
        </g>
        {/* Gold light travels along the same outline on each intentional selection. */}
        <path className="architecture-trace" pathLength="1" d="M76 106 153 73V46l48-23 75 21v29l49 13v29l-42 23-63-18-67-27-77 13" stroke="#efd7aa" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
        <g className="architecture-marker" style={{ '--marker-delay': '150ms' } as React.CSSProperties} transform="translate(101 66)">
          <path d="M0 0v25l45 13" stroke="currentColor" strokeOpacity="0.35" />
          <circle r="12" fill="#192e43" stroke="currentColor" strokeOpacity={activeTab === 'strategie' ? 1 : 0.3} />
        ...
        <g className="architecture-marker" style={{ '--marker-delay': '300ms' } as React.CSSProperties} transform="translate(339 39)">
          <path d="M0 0v20l-48 19" stroke="currentColor" strokeOpacity="0.35" />
          <circle r="12" fill="#192e43" stroke="currentColor" strokeOpacity={activeTab === 'finanzierung' ? 1 : 0.3} />
        ...
        <g className="architecture-marker" style={{ '--marker-delay': '450ms' } as React.CSSProperties} transform="translate(392 107)">
          <path d="M-12 0h-38l-26 11" stroke="currentColor" strokeOpacity="0.35" />
          <circle r="12" fill="#192e43" stroke="currentColor" strokeOpacity={activeTab === 'immobilie' ? 1 : 0.3} />
